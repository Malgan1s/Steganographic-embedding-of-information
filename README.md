...
[2 Краткая теоретическая часть 5](#краткая-теоретическая-часть)
[2.1 Метод LSB 5](#_Toc119240566)
[2.2 Метод PM1 5](#_Toc119240567)
[2.3 Метод QIM 6](#_Toc119240567)
[2.4 Метод PVD 6](#_Toc119240567)
[2.5 Метод NMI 7](#_Toc119240567)
[2.6 Оценка эффективности встраивания 8](#_Toc119240567)
[3 Программная реализация стеганографического метода QIM
11](#программная-реализация-стеганографического-метода-qim-для-цифровых-изображений.)
[4 Вычислительные эксперименты 14](#вычислительные-эксперименты.)
[5 Выводы о проделанной работе 19](#_Toc119240570)
...
![Интерполяция изображения на этапе встраивания 1](images/image1.png) ![Интерполяция изображения на этапе встраивания 2](images/imagee.png) ![Интерполяция изображения на этапе встраивания 3](images/image2.png) 
...
изображение $P$, как это показано на рисунке 2.
...
Программная реализация метода QIM представлена на рисунках 1, 2 и 3.
...
Рисунок 1 - Программная реализация метода QIM. Часть 1
...
Рисунок 2 - Программная реализация метода QIM. Часть 2
...
Рисунок 3 - Программная реализация метода QIM. Часть 3

![](media/image14.png){width="6.496527777777778in"
height="3.546527777777778in"}

Рисунок 4 – Пример результата выполнения программы

# 4 Вычислительные эксперименты.

4.1 Встраивание максимально возможного для данного контейнера объема
информации:

Возьмём для оценки фотографию, представленную на рисунке 5:

![](media/image15.png){width="3.59375in" height="4.791666666666667in"}

Рисунок 5 – Фотография
...
встраивания имеют значения, продемонстрированные на рисунке 6.

![](media/image16.png){width="2.3645833333333335in"
height="0.9270833333333334in"}

Рисунок 6 – Метрики незаметности встраивания для сообщения из 1 символа

Теперь встраиваем сообщение, состоящие из 480000 символов используя
функцию print(encryption(\"5.jpg\", \"1\" \* 600 \* 800, 4)). Получаем
значения незаметности встраивания, предоставленные на рисунке 7.

![](media/image17.png){width="2.4479166666666665in"
height="0.9479166666666666in"}

Рисунок 7 – Метрики незаметности встраивания для сообщения из 480000
символов
...
4.2 Проверим, как изменяются метрики незаметности встраивания от
встраивания разного количества информации в изображении из рисунка 5.

Для этого воспользуемся функцией print из программы, представленной в
пункте 3. Получаем значения, продемонстрированные в таблице 1:

Таблица 1 – Изменения метрик незаметности встраивания

  -----------------------------------------------------------------------
  Размер сообщения  Метрика MSE       Метрика RMSE      Метрика PSNR
  от макс.                                              
  возможного                                            
  значения                                              
  ----------------- ----------------- ----------------- -----------------
...
4.3 Встроим сообщения состоящие из 240 000 единиц в картинку,
представленную на рисунке 5. Затем, применяем сжатие с помощью функции,
представленной на рисунке 8.

![](media/image18.png){width="5.927083333333333in"
height="2.0729166666666665in"}

Рисунок 8 – Функция сжатия
...
Рисунок 9 – Результат расшифровки
...
на рисунке 5. Для построения гистограмм воспользуемся программой,
представленной на рисунке 10.

![Изображение выглядит как текст, снимок экрана, Шрифт Автоматически
созданное описание](media/image20.png){width="3.7284514435695537in"
height="4.1008978565179355in"}

Рисунок 10 – Программа для построения гистограмм

Результат работы программы представлен на рисунке 11.

> ![Изображение выглядит как текст, снимок экрана, диаграмма, График
> Автоматически созданное
> описание](media/image21.png){width="5.2995089676290466in"
> height="2.9638320209973754in"}
>
...
Tutorial - Pillow. – URL:
https://pillow.readthedocs.io/en/stable/handbook/tutorial.html (дата
